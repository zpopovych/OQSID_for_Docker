...
println(" MULTI DURATION SYSTEM IDENTIFICATION w CONSTRAINED TSSOS and KOSSAKOWSKI Frobenius objective QO simulation")
...
tests_data_file_name = "MULT_KOSSAK_CONSTR_TSSOS_threshold_1e"*rltrs*"_FROB_QO.h5"#*date_and_time_string * ".h5"
...
for γᵢ in γ
    ...
    for t_duration in duration_steps
        ...
        elapsed_time = @timed begin
            ...
            polyGEXYfull = kossak_GEXY_obj(ρ_masked, t_masked, Hˢʸᵐᵇ, Cˢʸᵐᵇ, fᴷᴼᴺᴮ)
        ...
        h5open(tests_dir*tests_data_file_name,"cw") do fid
            ...
            t_group["C"] = convert.(ComplexF64, Cˢⁱᵈ)
